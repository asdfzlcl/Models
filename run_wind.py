...
parser = argparse.ArgumentParser(description='SCINet on WIND dataset')

parser.add_argument('--model', type=str, required=False, default='SCINet', help='model of the experiment')
### -------  dataset settings --------------
parser.add_argument('--data', type=str, required=False, default='huashengdunu0', choices=['huashengdunu0', 'jiduou0', 'niuyueu0','shengbidebaou0','xicahngu0','xinjiapou0'],
                    help='name of dataset')
parser.add_argument('--root_path', type=str, default='./datasets/wind/', help='root path of the data file')
parser.add_argument('--data_path', type=str, default='huashengdunu0.csv', help='location of the data file')
...
parser.add_argument('--seq_len', type=int, default=16, help='input sequence length of SCINet encoder, look back window')
...
if args.evaluate:
    setting = '{}_{}_ft{}_sl{}_ll{}_pl{}_lr{}_bs{}_hid{}_s{}_l{}_dp{}_inv{}_itr0'.format(args.model, args.data,
                                                                                         args.features, args.seq_len,
                                                                                         args.label_len, args.pred_len,
                                                                                         args.lr, args.batch_size,
                                                                                         args.hidden_size, args.stacks,
                                                                                         args.levels, args.dropout,
                                                                                         args.inverse)
    ...
    if args.itr:
        ...
        setting = '{}_{}_ft{}_sl{}_ll{}_pl{}_lr{}_bs{}_hid{}_s{}_l{}_dp{}_inv{}_itr0'.format(args.model, args.data,
                                                                                             ...
                                                                                             args.batch_size,
                                                                                             args.hidden_size,
                                                                                             args.stacks, args.levels,
                                                                                             args.dropout, args.inverse)
        exp = Exp(args)  # set experiments
        print('>>>>>>>start training : {}>>>>>>>>>>>>>>>>>>>>>>>>>>'.format(setting))
        exp.train(setting)
